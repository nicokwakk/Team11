...
?>
<body>
  <form action='https://zeno.computing.dundee.ac.uk/2017-ac32006/team11/web/updateProduct.php?productID=<?php echo $prodID ?>'>
  <div class='prodSelect'>
  <label for='productlist'>Select Product to Update</label>
