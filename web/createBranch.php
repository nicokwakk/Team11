...
<html lang='en'>
	...
	<head>
		  ...
		  <?php
				$add1=$add2=$postcode=$city=$country="";
				$add1Err=$add2Err=$postcodeErr=$cityErr="";
				...
				if ($_SERVER["REQUEST_METHOD"] == "POST") {
					...
					if($add1Err =="" && $add2Err=="" && $cityErr =="" && $postcodeErr=="")
					{
						$mysql->query( "CALL CreateBranch('$add1','$add2','$postcode','$country','$city',@bID)" );
